...
$string['signinsheetdeletepagecheck'] = 'Do you really want to delete the selected pages?';
...
$string['signinsheetimportedon'] = 'Imported on';
$string['signinsheetinvalidattendanceid'] = 'Invalid attendance ID.';
...
$string['signinsheetnocourse'] = 'The course with id {$a->course} that the offline quiz with ID {$a->offlinequiz} belongs to is missing.';
...
$string['signinsheetpreprocesserror'] = 'Pre-process error';
