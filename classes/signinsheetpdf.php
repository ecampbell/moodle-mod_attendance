 ...
 */
function signinsheet_create_pdf_participants($offlinequiz, $courseid, $list, $context) {
    global $CFG, $DB;
    ...
    $sql = "SELECT DISTINCT u.id, u." . $attendanceconfig->ID_field . ", u.firstname, u.lastname
              FROM {user} u,
                   {signinsheet_participants} p,
                   {role_assignments} ra,
