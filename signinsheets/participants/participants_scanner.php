 ...
 * Overwrites some methods of the class signinsheets_page_scanner.
 *
 * @author        Juergen Zimmer <zimmerj7@univie.ac.at>
 *
 */
class signinsheets_participants_scanner extends signinsheets_page_scanner {

    /**
     * (non-PHPdoc)
     * @see signinsheets_page_scanner::init_hotspots()
     */
