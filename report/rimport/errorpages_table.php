...
class signinsheets_selectall_table extends flexible_table {
    ...
    public function wrap_html_finish() {
        $strselectall = get_string('selectall', 'attendance');
        $strselectnone = get_string('selectnone', 'attendance');
        ...
        echo '&nbsp;&nbsp;';
        echo '<input type="submit" value="'.get_string('deleteselectedpages', 'signinsheets_rimport')
...
class signinsheets_partlist_table extends signinsheets_selectall_table {
    ...
    public function wrap_html_finish() {
        ...
        echo '<a href="#" class="deselectall">' . $strselectnone . '</a> ';
        echo '&nbsp;&nbsp;';
        $options = array('check' => get_string('checkparts', 'attendance'),
                'uncheck' => get_string('uncheckparts', 'attendance'));
